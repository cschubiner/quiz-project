			...
			for (int i = 0; i < quizzes.size(); i++) {
				out.println("<li>"
						...
						+ UserUtils.getUserLinkString(quizzes.get(i)
								.getAuthor())
						+ " - <b><a href=\"AdminDatabaseModificationServlet?removeQuizID="
						+ quizzes.get(i).getID()
						+ "\">Remove</a></b>"
						+ " - <b><a href=\"AdminDatabaseModificationServlet?clearQuizIDHistory="
						+ quizzes.get(i).getID()
						+ "\">Clear History</a></b>");
				if (AdminUtils.QuizIsReported(db, quizzes.get(i).getID())) {
