...
public class MultipleChoiceQuestion extends Question{
	...
	public String getQuestionHTML() {
		...
		String o2 = (answers[1].equals("")) ? "" : "<input type='radio' name='" + questionID +"options' value=2 >" + answers[1] + "<br>";
		String o3 = (answers[2].equals("")) ? "" : "<input type='radio' name='" + questionID +"options' value=3 >" + answers[2] + "<br>";
		String o4 = (answers[3].equals("")) ? "" : "<input type='radio' name='" + questionID +"options' value=4 >" + answers[3] + "<br>";
